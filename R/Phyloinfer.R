                         ...
                         TrjL=NULL, Nleap=NULL, szkappa=NULL, rand_leap=NULL)
{
  ...
  theta = rep(1,Ngrid)
  u  = switch(alg,
              HMC=U(theta,lik_init,invC,prec_alpha,prec_beta),
              splitHMC=U_split(theta,lik_init,invC,prec_alpha,prec_beta),
              MALA=U(theta,lik_init,invC,prec_alpha,prec_beta),
              aMALA=U_kappa(theta,lik_init,invC,prec_alpha,prec_beta),
              ESS=coal_loglik(lik_init,theta[-Ngrid]),
              stop('The algorithm is not in the list!'))
  du = switch(alg,
              HMC=U(theta,lik_init,invC,prec_alpha,prec_beta,TRUE),
              splitHMC=U_split(theta,lik_init,invC,prec_alpha,prec_beta,TRUE),
              MALA=U(theta,lik_init,invC,prec_alpha,prec_beta,TRUE),
              aMALA=NULL,
              ESS=NULL,
              stop('The algorithm is not in the list!'))
